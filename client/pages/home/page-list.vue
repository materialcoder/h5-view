  ...
  <div class="page-list-wrapper">
    ...
    <div class="page-list-content">
      <div class="page-list-nav">
        <div class="nav-item" @click="toggleSearch('my')" :class="{active: searchParams.type === 'my'}">我的作品({{myCount}})</div>
        <div class="nav-item" @click="toggleSearch('share')" :class="{active: searchParams.type === 'share'}">参与作品({{shareCount}})</div>
      </div>
      <div class="page-list-item" v-loading="loading">
        ...
        <div class="add-page-wrapper" v-for="(item, index) in pageList" :key="item._id">
  ...
  methods: {
    ...
    deletePage(id, index) {
      this.$confirm('此操作将永久删除该页面，是否继续？', '提示', {
        ...
        this.loading = true
        this.$axios.delete('/page/delete/' + id).then((res) => {
          this.loading = false
          if (res.code === 200) {
